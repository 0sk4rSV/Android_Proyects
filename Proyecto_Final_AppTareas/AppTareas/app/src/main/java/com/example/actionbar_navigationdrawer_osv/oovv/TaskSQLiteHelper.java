...
public class TaskSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String NOMBRE_TABLA = "tareas";
    private static final String sqlCreate = "CREATE TABLE IF NOT EXISTS tareas" +
            "(_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
            "titulo TEXT NOT NULL, " +
            "descripcion TEXT, " +
            "fechaLimite TEXT, horaLimite TEXT, " +
            "fechaCompleta TEXT, " +
            "usarRecordatorio INTEGER DEFAULT 0);";

    public TaskSQLiteHelper(@Nullable Context contexto, @Nullable String nombre, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
        super(contexto, "bdTareas", factory, version);
    }
